...
<div class="wrap">
 ...
 <section id="settings"><div class="grid">
  <div class="card"><h2>⚙️ Konfigurasi</h2>
    ...
    <div class="row"><span>Auto-powerup</span><b id="s_pwr">—</b></div>
    <div class="row"><span>Belanja hari ini</span><b id="s_buy">—</b></div></div>
...
async function tick(){
 try{
  ...
  $('s_buy').textContent=fmt(d.buySpent)+' / '+fmt(s.buyCap)+' OTWN';
  drawChart(d.hourly||[]);
